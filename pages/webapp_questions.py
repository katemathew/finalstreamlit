...
def app():
    ...
    **What skills did you wish you had while you were doing the project?**
    Debugging and Familiarity With Github and Streamlit: This was the most time-consuming aspect of the project, especially when trying to combine datasets with different names, upload them to Github, and then create the streamlit app, which caused many disconnects. Advanced Math: In the future, I would like to employ more math-based insights into my data analysis and visualizations. I was able to use my knowledge from statistics, but a deeper foundation in math would be useful.
    """)
